  ...
  return (
    <header className="max-w-[1180px] px-[30px] lg:px-0 flex items-center justify-between w-full mx-auto py-5">
      ...
      <nav className="hidden lg:flex items-center gap-2.5">
        <Link className="text-[14px] font-semibold inline-block py-3 px-5" href={"/marketplace"}>Marketplace</Link>
        <Link className="text-[14px] font-semibold inline-block py-3 px-5" href={"/rankings"}>Rankings</Link>
        <Link className="text-[14px] font-semibold inline-block py-3 px-5" href={"/connect-wallet"}>Connect a wallet</Link>
